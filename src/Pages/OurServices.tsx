...
const services: Service[] = [
  ...
  {
    title: "Loans",
    Icon: FaHandHoldingUsd as React.ComponentType<
        ...
        >
          <motion.div className="bg-black bg-opacity-20 p-4 sm:p-6 md:p-8 rounded-md max-w-xl text-white z-10">
            ...
            <p className="text-sm sm:text-base">
              Explore the diverse range of services we offer to help you manage
        ...
        <section className="pt-28 sm:pt-32 md:pt-40 pb-20 bg-gray-50 px-4 sm:px-6 md:px-10 space-y-16">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600">
              At ASPAC Bank, we prioritize your financial security and
              convenience. Our services are tailored to help you reach your
          ...
          >
            ...
            <div className="lg:w-1/2">
              <h3 className="text-sm text-green-700 font-semibold mb-2">
                Customer Support
              </h3>
              ...
              <p className="text-gray-600 mb-4">
                Our bank is available Monday to Friday, 9 AM to 3 PM — always
                ready to assist you.
              </p>
              <button
