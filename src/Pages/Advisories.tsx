...
const ADVISORIES: Advisory[] = [
  ...
  {
    id: "bogo-closure-2025",
    kind: "Closure",
    title: "Temporary Closure – ASPAC Bank Bogo City Branch",
    effective: "Effective Immediately",
    summary:
      "Our Bogo City Branch is temporarily closed for renovations until further notice. Other branches remain ready to serve you.",
    paragraphs: [
      "Please be advised that our Bogo City Branch is temporarily closed for much-needed renovations. We will issue a public announcement once the branch reopens.",
      "During this period, deposits, withdrawals, and over-the-counter payments can be accommodated at any ASPAC Bank branch.",
    ],
    cta: {
      label: "Find Nearby Branches",
      href: "https://www.aspacbank.com/branches",
    },
    icon: <FaExclamationTriangle className="text-black" />,
    accent: "border-aspac-yellow",

    /** Embedded Nearby Branches section */
    extra: (
      <section
        id="nearby-branches"
        className="bg-white rounded-3xl border border-gray-100 shadow-brand p-6 sm:p-8 mt-8"
      >
