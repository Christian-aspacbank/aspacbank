      ...
      <div className="min-h-screen bg-gradient-to-br from-aspac-green/5 via-white to-aspac-green/10">
        ...
        >
          ...
          >
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.06)] overflow-hidden border border-gray-100">
              ...
              <div className="px-6 sm:px-8 py-8">
                <div className="rounded-2xl border border-aspac-yellow/70 bg-aspac-yellow/20 p-5 sm:p-6">
                  <p className="text-gray-800 leading-relaxed text-[15px] sm:text-base">
                    Starting{" "}
                    <strong className="text-primary">October 3, 2025</strong>,
                    in line with
                    ...
                    <strong className="text-primary">₱500,000</strong> will be
                ...
                {/* PDIC Notice */}
                <div className="mt-8 flex items-start gap-3 rounded-2xl bg-aspac-yellow/20 border border-aspac-yellow p-4">
                  <FaShieldAlt
                    className="text-aspac-yellow text-xl mt-0.5"
                    aria-hidden="true"
                  />
                  <p className="text-sm text-gray-700">
                    Deposits are insured by the{" "}
                    <span className="font-semibold text-primary">PDIC</span> up
                    to{" "}
          ...
          >
            ...
            <div className="bg-gradient-to-r from-aspac-yellow to-aspac-yellow p-6">
            ...
            <div className="p-8">
              <div className="text-gray-700 space-y-4 leading-relaxed">
                ...
                <div className="bg-gradient-to-br from-aspac-green/10 to-aspac-green/5 border-l-4 border-primary rounded-xl p-6 mt-6">
                  <p className="font-bold text-primary text-lg mb-6 flex items-center gap-2">
                ...
                <div className="bg-gray-50 rounded-xl p-5 mt-6">
                  ...
                  <div className="flex flex-wrap gap-4 mt-4">
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-primary hover:bg-aspac-green/90 text-white px-5 py-2.5 rounded-lg font-semibold transition shadow-sm"
                    >
                      <FaPhone />
                      0898-272-2724
                    </a>
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-primary border-2 border-primary px-5 py-2.5 rounded-lg font-semibold transition shadow-sm"
                    >
                      Visit Website
                    </a>
                  </div>
                ...
                <div className="border-t border-gray-200 pt-4 mt-6">
                  ...
                  <p className="font-semibold text-gray-700 mt-2">
                    Sincerely,
                    <br />
                    <span className="text-primary">ASPAC Bank Management</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            {/* Header with gradient */}
            <div className="bg-gradient-to-r from-primary to-aspac-green p-6">
              ...
              {googleMapsUrl && (
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-primary hover:bg-aspac-green/90 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition transform hover:scale-105"
                  >
                    <FaMapMarkerAlt />
                    View on Google Maps
                  </a>
