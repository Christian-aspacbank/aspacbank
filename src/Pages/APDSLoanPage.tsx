  ...
  return (
    <>
      ...
      <Seo
        ...
        description="Apply for a Teacher Salary Loan (APDS) with ASPAC Bank—fast approval, flexible terms, and dedicated support for teachers in Cebu."
        ...
        organization={{
          ...
          address: {
            streetAddress: "V. Rama Avenue, Guadalupe",
