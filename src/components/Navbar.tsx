      ...
      >
        <ul className="flex flex-col md:flex-row items-center justify-center w-full space-y-4 md:space-y-0 md:space-x-6 text-center">
          <li className="hover:text-green-600 cursor-pointer">
            <Link to="/our-services" onClick={() => setIsOpen(false)}>Services</Link>
          </li>
          <li className="hover:text-green-600 cursor-pointer">
            <Link to="/features" onClick={() => setIsOpen(false)}>Features</Link>
          </li>
          <li className="hover:text-green-600 cursor-pointer">
            <Link to="/advisories" onClick={() => setIsOpen(false)}>Advisories</Link>
          </li>
          <li className="hover:text-green-600 cursor-pointer">
            <Link to="/careers" onClick={() => setIsOpen(false)}>Careers</Link>
          </li>
          <li className="hover:text-green-600 cursor-pointer">
            <Link to="/branches" onClick={() => setIsOpen(false)}>Branches</Link>
          </li>
